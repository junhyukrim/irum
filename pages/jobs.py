...
def show_jobs_page():
    ...
    st.session_state['job_data']["openings"] = openings
    st.session_state['job_data']["deadline"] = str(deadline)
    st.session_state['job_data']["requirements"] = requirements
    st.session_state['job_data']["main_duties"] = main_duties
    st.session_state['job_data']["motivation"] = motivation
    st.session_state['job_data']["submission"] = submission
    st.session_state['job_data']["contact"] = contact
    st.session_state['job_data']["company_website"] = company_website
    st.session_state['job_data']["company_intro"] = company_intro
    st.session_state['job_data']["talent"] = talent
    st.session_state['job_data']["preferences"] = preferences
    st.session_state['job_data']["company_culture"] = company_culture
    st.session_state['job_data']["faq"] = faq
    st.session_state['job_data']["additional_info"] = additional_info
